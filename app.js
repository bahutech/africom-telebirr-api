...
function applyUserToken(username, password) {
  ...
  return new Promise((resolve, reject) => {
    ...
    var options = {
      ...
      headers: {
        Cookie:
          "mailchimp_landing_site=https%3A%2F%2Faliexpress.andagna.com%2Fwp-json%2F",
      },
    };
    console.log(options);
...
function getProductSingle(id) {
  ...
  var url_single =
    "https://aliexpress.andagna.com/wp-json/wc/v3/products/" + id;
  return new Promise((resolve, reject) => {
    var options = {
      url: url_single,
      auth: {
...
var sliderList = [
  {
    id: 1,
    picurl:
      "https://ae01.alicdn.com/kf/S6645b6fd8c684c6883d3de87aaff8971Q/444x280.png",
    title: "jewelery",
  },
  {
    id: 2,
    picurl:
      "https://ae01.alicdn.com/kf/S92d630fabc0942c4b408615a25cf1929V/960x557.jpg",
    title: "Electronics",
  },
  {
    id: 3,
    picurl:
      "https://cdn.it120.cc/apifactory/2019/06/18/06b337d7-92a1-498b-8142-5c5951e8fb97.jpg",
    title: "Promotion",
  },
  {
    id: 4,
    picurl:
      "https://cdn.it120.cc/apifactory/2019/06/18/4c458676-85bb-4271-91a6-79ed9fc47545.jpg",
    title: "Ecommerce",
  },
  {
    id: 5,
    picurl:
      "https://dcdn.it120.cc/2022/02/02/d0442c95-cd44-435a-888d-2539c5399334.png",
    title: "aliexpress",
  },
  {
    id: 6,
...
app.options("*", cors()); // Your other middleware and route handlers
app.use((req, res, next) => {
  next();
});
